...
test('production manifest and icons satisfy PWA metadata requirements', async () => {
  ...
  assert.deepEqual(pngSize(await readFile(path.join(root, 'dist', 'favicon-vmt-48.png'))), { width: 48, height: 48 })
  ...
  assert.match(html, /rel="icon" type="image\/png" sizes="48x48" href="\/favicon-vmt-48\.png"/)
