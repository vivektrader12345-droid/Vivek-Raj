...
test('production manifest and icons satisfy PWA metadata requirements', async () => {
  ...
  assert.match(html, /rel="icon" type="image\/x-icon" sizes="48x48" href="\/favicon\.ico\?v=20260910"/)
  assert.match(html, /rel="icon" type="image\/png" sizes="48x48" href="\/icons\/favicon-48\.png\?v=20260910"/)
